...
namespace DAL_PolyCafe
{
    ...
    {
        public static string connString = @"Data Source=DESKTOP-0B47B2G\SQLEXPRESS;Initial Catalog=SOF2052_PolyCafe;Integrated Security=True;TrustServerCertificate=True";
